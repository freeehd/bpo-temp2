...
function FloatingCard({
  ...
  useEffect(() => {
    ...
    const moveX = distanceX * strength * 0.03
    const moveY = distanceY * strength * 0.03
  ...
  return (
    ...
    >
      <div className="relative w-full h-full p-6 rounded-lg border border-gray-200 bg-white shadow-md transition-all duration-300 hover:scale-105 hover:shadow-lg group overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-3 flex items-center justify-center">
            <div className="text-center max-w-3xl mx-auto my-20 relative z-20">
              <motion.h1
